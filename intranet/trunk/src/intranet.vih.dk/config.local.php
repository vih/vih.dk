<?php
define('PATH_INCLUDE',
'/home/lsolesen/workspace/ilib/3Party/Structures_Ical/src/' . PATH_SEPARATOR .
dirname(__FILE__) . '/../' . PATH_SEPARATOR . dirname(__FILE__) . '/../../../../hojskole/src/' . PATH_SEPARATOR . get_include_path());
