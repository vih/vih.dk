...
class VIH_Calender_ApplicationFactory
{
    ...
    {
        $this->appapikey = '9da50315d6e4dbe2149c760f99b5fbb6';
        $this->appsecret = '7e8238c0e9ea4b5ec25c406ad85e2acf';
    }
    ...
    {
        return new Facebook($this->appapikey, $this->appsecret);
    }
...
class VIH_Calender_Foredrag extends k_Component
{
    ...
    function addEventPage($event)
    {
        ...
        $this->pdf->Ln();
        $this->pdf->Write(0, 'Tilmelding: Send en e-mail til lars@vih.dk');
    }
...
class VIH_Calender_Facebook extends VIH_Calendar_Publish
{
    ...
    function __construct(Facebook $facebook, VIH_Calendar_TableGateway $gateway, k_TemplateFactory $template)
    {
        ...
        $user_id = $this->facebook->require_login();
    }
    ...
    function postForm()
    {
        if (!$this->facebook->api_client->users_hasAppPermission('create_event')){
        ...
        //$long_description = 'MultiidrÃ¦tsforeningen VIMI fortÃ¦ller hvad de byder pÃ¥ og laver en times spinning med pedellen.';
        ...
        try {
            $event_id = $this->facebook->api_client->events_create(json_encode($data));
...
class VIH_Calender_Kultunaut extends VIH_Calendar_Publish
{
    ...
    function postForm()
    {
        ...
        $data['side'] = 'sted';
        $data['StedNr'] = 321810; // Vejle Idrætshøjskole
        $data['SkiftArrang'] = 'no';
