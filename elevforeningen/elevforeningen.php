...
class elevforeningen_postinstall {
    ...
    private $settings = array(
        ...
        5 => 'path_www',
        6 => 'path_template',
        7 => 'path_template_kundelogin',
        8 => 'intraface_private_key',
        9 => 'quickpay_merchant_id',
        10 => 'quickpay_md5_secret'
    );
    ...
    public function init($config, $self = null, $lastInstalledVersion = null) {
        ...
        $this->_php_dir = '';
        $this->_config_file = $this->_web_dir . 'elevforeningen/config.elevforeningen.php';
