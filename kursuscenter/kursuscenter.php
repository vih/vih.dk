...
class kursuscenter_postinstall {
    ...
    public function init($config, $self = null, $lastInstalledVersion = null) {
        ...
        $this->_php_dir = '';
        $this->_config_file = $this->_web_dir . 'kursuscenter/config.kursuscenter.php';
    ...
    function setupEnvironment($answers)
    {
        ...
        if (PEAR::isError($error_check)) {
            $this->_ui->outputData($error_check->getMessage() . ' ' . $this->_config_file);
            return false;
        }
