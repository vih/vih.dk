 <h1>Organisation</h1>
        ...
        <ul>
            <li>Bestyrelsen</li>
            <li>En repræsentant fra hvert af de under Danmarks Idræts-Forbund støende specialforbund</li>
        ...
        -->
        <h3>Forstander</h3>
        <p>Forstanderen har ansvaret for den daglige ledelse på Vejle Idrætshøjskole. Han sidder med i medarbejderrådet og lærerrådet.</p>
        ...
        <p>Beslutningsprocessen afhænger af, hvilken type beslutninger, der skal træffes og af hvilket omfang de har. Forstanderen har det daglige ansvar, men han har uddelegeret beslutninger til fx forretningsfører og kursuschef.</p>
