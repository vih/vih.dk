<?php
class VIH_Controller_RSS_Index extends k_Controller
{
    public $map = array('kortekurser' => 'VIH_Controller_RSS_Kortekurser',
                        'nyheder' => 'VIH_Controller_RSS_Nyheder',
                        'langekurser' => 'VIH_Controller_RSS_Langekurser');

    function GET()
    {
        $this->document->title = 'RSS-feeds';
        $meta['description'] = '';
        $meta['keywords'] = '';
        ...
        ', 'content_sub' => '<h2>Vores RSS-feeds</h2>
            <ul>
                <li class="rss"><a href="'.$this->url('nyheder').'">Nyheder</a></li>
                <li class="rss"><a href="'.$this->url('kortekurser').'">Korte kurser</a></li>
                <li class="rss"><a href="'.$this->url('langekurser').'">Lange kurser</a></li>
            </ul>
