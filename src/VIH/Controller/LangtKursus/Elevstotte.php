...
class VIH_Controller_LangtKursus_Elevstotte extends k_Component
{
    ...
    function renderHtml()
    {
        ...
        <ol>
            ...
            <li>Elever, der inden opholdet har fungeret som ledere, instruktører eller trænere i foreningslivet i mindst &eacute;n sæson, kan tildeles op til 200,- kr pr. uge. Formået med støtten er at motivere nuværende trænere til et længerevarende højskoleophold af mindst 18 ugers varighed. For at komme i betragtning skal din klubformand fremsende dokumentation og motiveret anbefaling. </li>
