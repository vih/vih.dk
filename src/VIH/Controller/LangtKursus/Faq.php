...
class VIH_Controller_LangtKursus_Faq extends k_Component
{
    ...
    function GET()
    {
        ...
        <p>Ugeprisen kan variere fra år til år. <a href="'.$this->url('/langekurser/økonomi').'">Læs mere om økonomien</a> i forbindelse med et ophold på Vejle Idrætshøjskole. Du kan søge <a href="'.url('/langekurser/elevstøtte.php').'">elevstøtte</a> som hjælp til at gøre dit ophold billigere.</p>
        ...
        <p>Ja. For at alle kan få det bedst mulige ophold, har vi fire simple forudsætninger, som alle elever skal overholde. Vi har beskrevet forudsætningerne i <a href="'.url('/langekurser/højskoleliv#forudsætninger').'">Jyske Lov</a>.</p>
