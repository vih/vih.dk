<?php
class VIH_Controller_LangtKursus_Faq extends k_Controller
{
    function GET()
    {
        ...
        <p>Ugeprisen kan variere fra år til år. <a href="'.$this->url('/langekurser/okonomi').'">Læs mere om økonomien</a> i forbindelse med et ophold på Vejle Idrætshøjskole. Du kan søge <a href="'.url('/langekurser/elevstotte.php').'">elevstøtte</a> som hjælp til at gøre dit ophold billigere.</p>
        ...
        <p>Ja, det kan du! Du kan blive siddende og kigge på vores <a href="'.url('/faciliteter').'">faciliteter</a>, eller du kan ringe til skolen og aftale et tidspunkt for en rundvisning.</p>
        <h3>7. Har I nogle regler for eleverne?</h3>
        <p>Ja. For at alle kan få det bedst mulige ophold, har vi fire simple forudsætninger, som alle elever skal overholde. Vi har beskrevet forudsætningerne i <a href="'.url('/langekurser/hojskoleliv#forudsaetninger').'">Jyske Lov</a>.</p>
        <h3>Flere spørgsmål?</h3>
        <p>Hvis du har flere spørgsmål, er du meget velkommen til at <a href="'.url('/kontakt').'">ringe</a> til os, eller du kan <a href="'.url('/kontakt/').'">skrive en e-mail</a>.</p>
